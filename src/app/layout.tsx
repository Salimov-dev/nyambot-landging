...
export const metadata: Metadata = {
  ...
  description:
    "Один бот в MAX и Telegram на всю сеть точек: своя база клиентов, повторные заказы без комиссии агрегатора, CRM, приложение «Команда», интеграция с iiko и R-Keeper, доставка через Яндекс.Доставку. 7 дней бесплатно.",
  keywords: [
    "Нямбот",
  ...
  openGraph: {
    ...
    description:
      "Веди всю сеть через один канал в MAX и Telegram, работай со своими клиентами напрямую — без комиссии с чека. CRM, приложение «Команда», iiko и R-Keeper, доставка через Яндекс.Доставку. 7 дней бесплатно.",
    images: [
      {
