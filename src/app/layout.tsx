...
export const metadata: Metadata = {
  ...
  description:
    "Платформа для собственной доставки еды через Telegram и MAX через мини-приложение без агрегаторов. Собственная CRM, курьерское приложение, программа лояльности и промокоды — всё в одном тарифе. 0% комиссии. 7 дней бесплатно.",
  keywords: [
    "Нямбот",
