...
export const metadata: Metadata = {
  ...
  description:
    "Платформа для собственной доставки еды через мини-приложение Telegram и MAX без агрегаторов. Собственная CRM, курьерское приложение, программа лояльности и промокоды — всё в одном тарифе. 0% комиссии. 7 дней бесплатно.",
  keywords: [
    "Нямбот",
