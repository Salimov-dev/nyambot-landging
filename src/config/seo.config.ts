...
export const SEO_CONFIG = {
  ...
  description:
    "Нямбот — свой канал заказов для кафе, ресторанов и пекарен: один бот на MAX и Телеграм и на всю сеть. Гость заказывает без установки и регистрации, платит онлайн. Фиксированная подписка вместо процента с заказа, поможем настроить. 90 дней бесплатно",
  ogImage: "/images/og-cover.png",
  ogImageAlt:
    "Нямбот — заказы и доставка еды в MAX и Телеграм: гость открывает меню заведения прямо в мессенджере, без установки приложения",
  ogImageWidth: 1200,
  ogImageHeight: 630,
} as const;
