...
export const SEO_CONFIG = {
  ...
  description:
    "Нямбот — свой канал заказов для кафе, ресторанов и пекарен: один бот на MAX и Телеграм и на всю сеть. Гость заказывает без установки и регистрации, платит онлайн. Фиксированная подписка вместо процента с заказа, поможем настроить. 30 дней бесплатно",
