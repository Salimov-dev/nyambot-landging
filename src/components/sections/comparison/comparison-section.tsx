...
export function ComparisonSection() {
  ...
  const ROWS: ComparisonRow[] = [
    ...
    {
      key: "clients",
      feature: t("comparison.rows.clients"),
      nyambot: true,
      botServices: t("comparison.partial"),
      yandexEda: false,
      others: false,
    },
    {
      key: "network",
      feature: t("comparison.rows.network"),
      nyambot: true,
      botServices: false,
      yandexEda: false,
      others: false,
    ...
    {
      key: "crew",
      feature: t("comparison.rows.crew"),
      nyambot: true,
      botServices: false,
      yandexEda: false,
      others: false,
    ...
    {
      key: "adminApp",
      feature: t("comparison.rows.adminApp"),
      nyambot: true,
      botServices: false,
      yandexEda: false,
      others: false,
    ...
    {
      key: "delivery",
      feature: t("comparison.rows.delivery"),
      nyambot: true,
      botServices: false,
      yandexEda: true,
      others: true,
    ...
    {
      key: "loyalty",
      feature: t("comparison.rows.loyalty"),
      nyambot: true,
      botServices: t("comparison.partial"),
      yandexEda: false,
      others: false,
    ...
    {
      key: "marketing",
      feature: t("comparison.rows.marketing"),
      nyambot: true,
      botServices: t("comparison.partial"),
      yandexEda: false,
      others: false,
    ...
    {
      key: "marketingAuto",
      feature: t("comparison.rows.marketingAuto"),
      nyambot: true,
      botServices: false,
      yandexEda: false,
      others: false,
    ...
    {
      key: "aiAssistant",
      feature: t("comparison.rows.aiAssistant"),
      nyambot: true,
      botServices: t("comparison.partial"),
      yandexEda: false,
      others: false,
    ...
    {
      key: "languages",
      feature: t("comparison.rows.languages"),
      nyambot: "7",
      botServices: "1–2",
      yandexEda: "1",
      others: "1–2",
    ...
    {
      key: "price",
      feature: t("comparison.rows.price"),
      nyambot: t("comparison.fixed"),
      botServices: t("comparison.fixedOrPercent"),
      yandexEda: t("comparison.fromRevenue"),
      others: t("comparison.fromRevenue"),
    },
  ];
    ...
    },
    {
      ...
      onCell: () => ({
        style: {
          ...
          borderRight: `2px solid ${theme.colors.accentBorder}`,
        },
      }),
      onHeaderCell: () => ({
        style: {
