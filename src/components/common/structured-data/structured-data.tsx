  ...
  const graph = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        publisher: { "@id": `${siteUrl}/#organization` },
        description:
          "Платформа собственного канала продаж в MAX и Telegram для сетей общепита и микро-ритейла: один бот на все точки сети, своя база клиентов, повторные заказы без комиссии агрегатора, CRM, приложение «Команда» для администратора и курьера, интеграция с iiko и доставка через Яндекс.Доставку.",
        offers: {
          "@type": "Offer",
          priceCurrency: "RUB",
          price: basePrice,
