  ...
  const graph = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        publisher: { "@id": `${siteUrl}/#organization` },
        description:
          "Собственный канал приёма заказов и доставки в MAX и Телеграм для общепита и микро-ритейла: один бот на оба мессенджера и на все точки сети, общая база гостей, история заказов и баллы. Гость заказывает без установки приложения и регистрации, платит онлайн на счёт заведения. Фиксированная подписка вместо процента с заказа: повторные заказы идут без комиссии агрегатора. СРМ, приложение «Команда» для администратора и курьера, акции и промокоды, интеграция с iiko и R-Keeper, доставка через Яндекс.Доставку, помощь с настройкой.",
        offers: {
          "@type": "Offer",
          priceCurrency: "RUB",
          price: basePrice,
