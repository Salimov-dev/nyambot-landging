...
const SOCIALS: {
...
}[] = [
  {
    ...
    icon: "/images/social/tg.png",
    goal: "click_social_telegram",
  },
  {
    key: "max",
    label: "MAX",
    href: LINKS.social.max,
    icon: "/images/social/max.svg",
    goal: "click_social_max",
  },
  {
    key: "rutube",
    label: "Rutube",
    href: LINKS.social.rutube,
    icon: "/images/social/rutube.png",
    goal: "click_social_rutube",
  },
  {
    key: "vk",
    label: "ВКонтакте",
    href: LINKS.social.vk,
    icon: "/images/social/VK.png",
    goal: "click_social_vk",
  },
  {
    key: "youtube",
    label: "YouTube",
    ...
    goal: "click_social_youtube",
  },
  {
    key: "ok",
    label: "Одноклассники",
    href: LINKS.social.ok,
